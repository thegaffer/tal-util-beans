...
/**
 * This bean is similar in structure to {@link AnotherBean},
 * but one of the properties has been renamed to test the
 * {@link GenericMapper}/
 *
 * @author Tom Spencer
 */
public class NearlySimilarBean implements NearlySimilar {

    private String differentVal = "String";
    ...
    public NearlySimilarBean(String val) {
     ...
     */
    public void setDifferentVal(String stringVal) {
        this.differentVal = stringVal;
    }
    /**
     * @return the dblVal2
     */
    ...
    public int hashCode() {
        ...
        result = prime * result + ((differentVal == null) ? 0 : differentVal.hashCode());
        return result;
    }
    ...
    public boolean equals(Object obj) {
        ...
        NearlySimilarBean other = (NearlySimilarBean)obj;
        if( boolVal2 == null ) {
        ...
        if( differentVal == null ) {
            if( other.differentVal != null ) return false;
        }
        else if( !differentVal.equals(other.differentVal) ) return false;
        return true;
    }
    ...
    public String toString() {
        return "AnotherBean [boolVal2=" + boolVal2 + ", charVal2=" + charVal2 + ", collectionVal=" + collectionVal + ", dblVal2=" + dblVal2 + ", fltVal2="
                ...
                + setOnlyVal + ", shrVal2=" + shrVal2 + ", stringVal=" + differentVal + "]";
    }
}
